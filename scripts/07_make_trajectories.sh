...
python -m src.eval.trajectory_examples \
  ...
  --output-dir outputs/main/trajectories/expert
...
python -m src.eval.trajectory_examples \
  ...
  --max-episode-steps 15 \
  --max-new-tokens 8 \
  --output-dir outputs/main/trajectories/sft_action
...
python -m src.eval.trajectory_examples \
  ...
  --max-episode-steps 15 \
  --max-new-tokens 8 \
  --output-dir outputs/main/trajectories/grpo_action
...
python -m src.eval.trajectory_examples \
  ...
  --max-episode-steps 15 \
  --max-new-tokens 40 \
  --output-dir outputs/main/trajectories/sft_text_action
...
python -m src.eval.trajectory_examples \
  ...
  --max-episode-steps 15 \
  --max-new-tokens 40 \
  --output-dir outputs/main/trajectories/grpo_text_action
